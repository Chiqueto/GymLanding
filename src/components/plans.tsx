...
function Plans() {
    return (
        <section className="flex flex-col items-center mt-20">
            <h1 className="font-impact font-bold md:text-6xl text-4xl text-zinc-50 md:px-48 text-center [text-shadow:_2px_4px_8px_rgb(198_67_8_/_75%)] stroke-main-600">Nossos planos e assinaturas</h1>
            ...
            <Carousel opts={{ loop: true }} className="w-full md:hidden">
                <CarouselContent>
            ...
            <h1 className="mt-20 font-impact font-bold md:text-6xl text-4xl text-zinc-50 px-48 text-center [text-shadow:_0_4px_12px_rgb(20_145_227_/_100%)] stroke-secondary-500">Também aceitamos</h1>
