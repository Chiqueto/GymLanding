    ...
    return (
        <footer className='bg-zinc-950 mt-10 py-5'>
            <ul className='flex justify-center gap-4'>
                <li className=''><SocialIcon url="https://x.com" bgColor='#FFFFFF' fgColor='#1B1B1B' style={{ height: 40, width: 40 }} /></li>
                <li><SocialIcon url="https://instagram.com" bgColor='#FFFFFF' fgColor='#1B1B1B' style={{ height: 40, width: 40 }} /></li>
                <li><SocialIcon url="https://facebook.com" bgColor='#FFFFFF' fgColor='#1B1B1B' style={{ height: 40, width: 40 }} /></li>
                <li><SocialIcon url="https://youtube.com" bgColor='#FFFFFF' fgColor='#1B1B1B' style={{ height: 40, width: 40 }} /></li>
                <li><SocialIcon url="https://whatsapp.com" bgColor='#FFFFFF' fgColor='#1B1B1B' style={{ height: 40, width: 40 }} /></li>
                <li><SocialIcon url="https://tiktok.com" bgColor='#FFFFFF' fgColor='#1B1B1B' style={{ height: 40, width: 40 }} /></li>
            </ul>
